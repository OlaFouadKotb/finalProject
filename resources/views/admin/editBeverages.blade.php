                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('beverages.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" id="title" name="title" value="{{$beverage-> title }}"  class="form-control">
                                    @error('title')
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <textarea id="content" name="content"  value="{{$beverage->content }}" class="form-control"></textarea>
                                    @error('content')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input id="price" class="form-control" type="number" step="0.01" name="price"  value="{{$beverage->price }}" >
                                    @error('price')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                @if($beverage->image)
                                    ...
                                    @endif
                                    <input type="file" id="image" name="image" class="form-control" enctype="multipart/form-data">
                                    @error('image')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        <option value="Hot Coffee" {{ $beverage->'category' == 'Hot Coffee' ? 'selected' : '' }}>Hot Coffee</option>
                                        <option value="Cold Coffee" {{$beverage->'category' == 'Cold Coffee' ? 'selected' : '' }}>Cold Coffee</option>
                                        <option value="Fruit Juice" {{ $beverage->'category' == 'Fruit Juice' ? 'selected' : '' }}>Fruit Juice</option>
                                        <option value="special item" {{$beverage->'category' == 'special Items' ? 'selected' : '' }}>Special Items</option>
                                    </select>
                                    @error('category')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
