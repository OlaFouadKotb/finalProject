                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" action="{{ route('updateUser', $user->id) }}" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input id="email" name="email" value="{{ old('email', $user->email)}}" class="form-control" type="email" required="required">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="active" {{ old('active', $user->active) ? 'checked' : '' }}> Active class="flat" 
                                        </label>
                                    </div>
                                </div>
                            </div>
