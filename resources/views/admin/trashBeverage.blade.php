            ...
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('beverages.forceDelete', $beverage->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" onclick="return confirm('Are you sure you want to permanently delete this item?')" class="btn btn-danger" title="Delete Permanently">
                        ...
                        <a href="{{ route('beverages') }}" class="btn btn-secondary">Back to Beverages List</a>
                    </div>
                </div>
            </div>
        </div>
