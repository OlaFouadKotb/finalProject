...
Route::get('/drinks1', [DrinkController::class, 'index2'])->name('drinks.index');
Route::get('/special-items', [DrinkController::class, 'specialItems'])->name('products.special');
...
Route::get('/messages/unread-count', [MessagesController::class, 'countUnread'])->name('messages.unread.count');
//contact routes
############################
